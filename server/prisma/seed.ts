...
async function main() {
  ...
  if (existingExam) {
    ...
    const exam = await prisma.exam.create({
      data: {
        ...
        description:
          'Transport Canada Aircraft Maintenance Engineer examination for Category M1 — Structures, Systems and Components. ' +
  ...
  const questions = [
    // ── MCQ / Easy ──────────────────────────────────────────────────────────
    {
      ...
      question:
        'Which aluminum alloy is most commonly used in aircraft skin panels and structural members?',
      options: ['2024-T3', '6061-T6', '7075-T6', '5052-H32'],
      correctAnswer: '2024-T3',
      explanation:
        '2024-T3 is a heat-treated aluminum-copper alloy (4.5% Cu) widely used in aircraft skin, ' +
    ...
    },
    {
      ...
      difficulty: 'EASY' as const,
      question:
        'Which of the following is classified as a "longitudinal" structural member of a fuselage?',
      options: ['Frame', 'Bulkhead', 'Stringer', 'Skin'],
      correctAnswer: 'Stringer',
      explanation:
        'Stringers (also called longerons when running full length) are longitudinal members that run ' +
    ...
    },
    {
      ...
      difficulty: 'EASY' as const,
      question:
        'What is the primary purpose of a doubler plate in aircraft structural repair?',
      options: [
        'To reduce weight',
      ...
      explanation:
        'A doubler (or reinforcement plate) is added over existing structure to restore strength ' +
    ...
    },
    {
      ...
      difficulty: 'EASY' as const,
      question:
        'Intergranular corrosion is most likely to occur in which aluminum alloy condition?',
      options: [
        '2024-T3 clad sheet',
      ...
      explanation:
        'Intergranular (exfoliation) corrosion occurs in 2024-T3 bare (un-clad) sheet when grain ' +
    ...
    // ── MCQ / Medium ─────────────────────────────────────────────────────────
    {
      ...
      question:
        'A sheet metal repair uses a flush rivet instead of a protruding-head rivet. What is the main reason for choosing flush rivets?',
      options: [
      ...
      explanation:
        'Flush (countersunk) rivets provide a smooth aerodynamic surface with no protruding head. ' +
    ...
    },
    {
      ...
      difficulty: 'MEDIUM' as const,
      question:
        'Which NDT method uses a ferro-magnetic powder to detect surface and near-surface discontinuities?',
      ...
      explanation:
        'Magnetic particle inspection (MPI) magnetizes a ferromagnetic part and applies iron powder; ' +
    ...
    },
    {
      ...
      difficulty: 'MEDIUM' as const,
      question:
        'In a shear splice repair of a 2024-T3 skin panel, what is the maximum permissible gap between the splice plates before a filler material must be used?',
      options: ['0.010 inch', '0.020 inch', '0.030 inch', '0.060 inch'],
      correctAnswer: '0.030 inch',
      explanation:
        'TC and FAR/TSO repair manuals generally specify a maximum gap of 0.030 inch (0.76 mm) ' +
    ...
    },
    {
      ...
      difficulty: 'MEDIUM' as const,
      question:
        'What type of fatigue crack propagation pattern would you expect in a 2024-T3 alloy sheet loaded in tension?',
      options: [
      ...
      explanation:
        'Fatigue cracks in 2024-T3 propagate with characteristic striations (beach marks) visible ' +
    ...
    // ── MCQ / Hard ───────────────────────────────────────────────────────────
    {
      ...
      question:
        'A honeycomb composite panel with aluminum facings has sustained impact damage. What is the correct repair sequence according to SRM Chapter 51?',
      options: [
      ...
      explanation:
        'Honeycomb repair requires complete removal of damaged core and facing back to sound structure. ' +
    ...
    },
    {
      ...
      difficulty: 'HARD' as const,
      question:
        'Under sustained tensile loading at elevated temperature (100°C), which failure mechanism is most critical for 7075-T6 aluminum alloy?',
      options: [
      ...
      explanation:
        '7075-T6 is highly susceptible to Stress Corrosion Cracking (SCC) when simultaneously subject ' +
    ...
    },
    {
      ...
      difficulty: 'HARD' as const,
      question:
        'When installing solid rivets in a 2024-T3 skin repair, which rivet material and condition would be most compatible with the existing structure?',
      ...
      explanation:
        '2117-T3 (formerly QQ-A-430) is the standard rivet alloy for aircraft structures, including ' +
    ...
    // ── TRUE/FALSE ───────────────────────────────────────────────────────────
    {
      ...
      difficulty: 'EASY' as const,
      question:
        'Alclad 2024-T3 sheet has a pure aluminum coating on both surfaces to improve corrosion resistance.',
      options: ['True', 'False'],
      correctAnswer: 'True',
      explanation:
        'Alclad is a composite sheet: a core of 2024-T3 is bonded between two layers of commercially ' +
    ...
    },
    {
      ...
      difficulty: 'MEDIUM' as const,
      question:
        'Cold-working a hole (bushhed or expanded bushed) increases its fatigue life by introducing beneficial compressive residual stresses at the hole edge.',
      options: ['True', 'False'],
      correctAnswer: 'True',
      explanation:
        'Cold-expansion processes (e.g., split-sleeve cold expansion, ILDR or "expanded and reduced" ' +
    ...
    },
    {
      ...
      difficulty: 'HARD' as const,
      question:
        'For a corrosion-patch repair on 2024-T3 bare (un-clad) sheet, it is acceptable to use 6061-T6 alloy for the patch doubler.',
      options: ['True', 'False'],
      correctAnswer: 'False',
      explanation:
        '6061-T6 has a different coefficient of thermal expansion and different galvanic potential than ' +
