        ...
        <article className="max-w-3xl mx-auto px-6 pt-16 pb-24">
          <header className="mb-12">
            <div className="flex items-center gap-3 mb-4">
              <span className="text-[11px] font-medium text-[#176B87] bg-[#176B87]/10 px-2 py-1 rounded">Study Plan</span>
              <span className="text-xs text-[#7A8B94]">May 22, 2026 *updated August 18, 2026</span>
              <span className="text-xs text-[#7A8B94]">· 11 min read</span>
            </div>
          ...
          <div className="flex items-center gap-3 mb-8 pb-6 border-b border-white/5">
            ...
            <div>
              ...
              <p className="text-xs text-[#7A8B94]">ICC exam preparation specialists — structured plans for busy inspectors</p>
            </div>
          </div>

          <div className="prose prose-invert max-w-none text-[#DCE4E7] leading-relaxed space-y-6">
            <h2 className="text-xl font-semibold text-[#102631] mt-10">How This Plan Works</h2>
            <p>
            ...
            <h2 className="text-xl font-semibold text-[#102631] mt-10">Phase 1: Map the Code (Weeks 1–2)</h2>
            ...
            <h2 className="text-xl font-semibold text-[#102631] mt-10">Phase 2: Drill Chapter by Chapter (Weeks 3–8)</h2>
            ...
            <h2 className="text-xl font-semibold text-[#102631] mt-10">Phase 3: Simulate and Harden (Weeks 9–12)</h2>
            ...
            <h2 className="text-xl font-semibold text-[#102631] mt-10">Daily Rhythm (45–60 Minutes)</h2>
            <ul className="list-disc pl-6 space-y-2">
            ...
            <h2 className="text-xl font-semibold text-[#102631] mt-10">Tools to Run This Plan</h2>
            <p>
