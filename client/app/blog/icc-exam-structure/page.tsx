        ...
        <nav className="border-b border-white/5 bg-[#0A0E1A]/80 backdrop-blur-md">
          <div className="max-w-3xl mx-auto px-6 py-4 flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              ...
              <a href="/fr/blog/icc-exam-structure" className="px-3 py-1 rounded-full bg-white/10 border border-white/20 hover:bg-white/20 text-sm font-medium transition-colors">FR</a>
            </div>
          </div>
        </nav>
        ...
        <article className="max-w-3xl mx-auto px-6 pt-16 pb-24">
          ...
          <div className="flex items-center gap-3 mb-8 pb-6 border-b border-white/5">
            ...
            <div>
              ...
              <p className="text-xs text-[#64748B]">ICC exam preparation specialists — exam-structure data verified against official ICC bulletins</p>
            </div>
          </div>

          <div className="prose prose-invert max-w-none text-[#CBD5E1] leading-relaxed space-y-6">
            <h2 className="text-xl font-semibold text-[#F8FAFC] mt-10">The Five Certifications at a Glance</h2>
              ...
              <table className="w-full text-sm border-collapse my-6">
                <thead>
                  <tr className="border-b border-white/10 text-left">
                    ...
                    <th className="py-2 pr-4 text-[#F8FAFC]">Scope</th>
                    <th className="py-2 pr-4 text-[#F8FAFC]">Code</th>
                    <th className="py-2 pr-4 text-[#F8FAFC]">Questions</th>
                    <th className="py-2 pr-4 text-[#F8FAFC]">Time</th>
                    <th className="py-2 text-[#F8FAFC]">Pass</th>
                  </tr>
                </thead>
                <tbody>
            ...
            <h2 className="text-xl font-semibold text-[#F8FAFC] mt-10">B1 — Residential Building Inspector (IRC)</h2>
            <p>
            ...
            <h2 className="text-xl font-semibold text-[#F8FAFC] mt-10">B2 — Commercial Building Inspector (IBC)</h2>
            <p>
            ...
            <h2 className="text-xl font-semibold text-[#F8FAFC] mt-10">E1 — Residential Electrical Inspector (NEC + IRC)</h2>
            <p>
            ...
            <h2 className="text-xl font-semibold text-[#F8FAFC] mt-10">P1 — Residential Plumbing Inspector (IPC + IRC)</h2>
            <p>
            ...
            <h2 className="text-xl font-semibold text-[#F8FAFC] mt-10">M1 — Residential Mechanical Inspector (IMC + IRC)</h2>
            <p>
            ...
            <h2 className="text-xl font-semibold text-[#F8FAFC] mt-10">How the Open-Book Format Changes Your Strategy</h2>
            <p>
              ...
              sections. Read our{' '}
              <a href="/blog/irc-study-guide" className="text-[#3B82F6] hover:text-[#60A5FA] transition-colors">
                IRC navigation guide
              </a>{' '}
              and{' '}
              <a href="/blog/icc-study-techniques" className="text-[#3B82F6] hover:text-[#60A5FA] transition-colors">
