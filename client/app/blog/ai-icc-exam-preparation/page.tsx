        ...
        <nav className="border-b border-white/5 bg-[#0A0E1A]/80 backdrop-blur-md">
          <div className="max-w-3xl mx-auto px-6 py-4 flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              ...
              <a href="/fr/blog/ai-icc-exam-preparation" className="px-3 py-1 rounded-full bg-white/10 border border-white/20 hover:bg-white/20 text-sm font-medium transition-colors">FR</a>
            </div>
          </div>
        </nav>
        ...
        <article className="max-w-3xl mx-auto px-6 pt-16 pb-24">
          <header className="mb-12">
            <div className="flex items-center gap-3 mb-4">
              <span className="text-[11px] font-medium text-[#3B82F6] bg-[#3B82F6]/10 px-2 py-1 rounded">Technology</span>
          ...
          <div className="flex items-center gap-3 mb-8 pb-6 border-b border-white/5">
            ...
            <div>
              ...
              <p className="text-xs text-[#64748B]">AI-powered ICC exam preparation — smarter studying for building inspectors</p>
            </div>
          </div>
          ...
          <div className="prose prose-invert max-w-none text-[#CBD5E1] leading-relaxed space-y-6">
            ...
            <h2 className="text-xl font-semibold text-[#F8FAFC] mt-10">Instant, Code-Referenced Explanations</h2>
            <p>
            ...
            <h2 className="text-xl font-semibold text-[#F8FAFC] mt-10">AI Tutoring for Open-Book Questions</h2>
            <p>
            ...
            <h2 className="text-xl font-semibold text-[#F8FAFC] mt-10">Try AI-Powered ICC Prep</h2>
            <p>
