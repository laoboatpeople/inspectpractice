        ...
        <article className="max-w-3xl mx-auto px-6 pt-16 pb-24">
          <header className="mb-12">
            <div className="flex items-center gap-3 mb-4">
              <span className="text-[11px] font-medium text-[#145A73] bg-[#145A73]/10 px-2 py-1 rounded">Study Skills</span>
              <span className="text-xs text-[#7A8B94]">May 23, 2026 *updated August 18, 2026</span>
          ...
          <div className="flex items-center gap-3 mb-8 pb-6 border-b border-white/5">
            ...
            <div>
              ...
              <p className="text-xs text-[#7A8B94]">ICC exam preparation specialists — helping inspectors pass open-book exams</p>
            </div>
          </div>

          <div className="prose prose-invert max-w-none text-[#DCE4E7] leading-relaxed space-y-6">
            <h2 className="text-xl font-semibold text-[#102631] mt-10">1. Learn the Chapter Map First</h2>
            <p>
            ...
            <h2 className="text-xl font-semibold text-[#102631] mt-10">2. Practice Index-First Lookups</h2>
            <p>
            ...
            <h2 className="text-xl font-semibold text-[#102631] mt-10">3. Use Active Recall, Not Re-Reading</h2>
            <p>
            ...
            <h2 className="text-xl font-semibold text-[#102631] mt-10">4. Answer Questions with the Code Open</h2>
            <p>
            ...
            <h2 className="text-xl font-semibold text-[#102631] mt-10">5. Study the Explanations, Especially the References</h2>
            <p>
            ...
            <h2 className="text-xl font-semibold text-[#102631] mt-10">6. Spaced Repetition for Section Numbers</h2>
            <p>
            ...
            <h2 className="text-xl font-semibold text-[#102631] mt-10">7. Take Timed Simulations Weekly</h2>
            <p>
            ...
            <h2 className="text-xl font-semibold text-[#102631] mt-10">8. Tab Your Code Strategically</h2>
            <p>
            ...
            <h2 className="text-xl font-semibold text-[#102631] mt-10">9. Read Questions for Qualifiers</h2>
            <p>
            ...
            <h2 className="text-xl font-semibold text-[#102631] mt-10">10. Track Your Weak Chapters and Attack Them</h2>
            <p>
            ...
            <h2 className="text-xl font-semibold text-[#102631] mt-10">Put It All Together</h2>
            <p>
