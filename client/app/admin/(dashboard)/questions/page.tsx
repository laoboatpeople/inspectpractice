          ...
          <div className="flex items-center gap-3 mb-3">
            <div className="flex-1">
              <select
                ...
                className="w-full px-3 py-2 bg-white border border-border rounded-btn text-sm text-text-primary focus:outline-none focus:ring-2 focus:ring-purple/50"
              >
            ...
            <div className="flex-1">
              <select
                ...
                className="w-full px-3 py-2 bg-white border border-border rounded-btn text-sm text-text-primary focus:outline-none focus:ring-2 focus:ring-purple/50 disabled:opacity-50"
              >
          ...
          <div className="flex items-end gap-3">
            <div className="flex-1 relative">
              <textarea
                ...
                disabled={sending}
                rows={2}
                className="w-full px-4 py-3 bg-white border border-border rounded-btn text-sm text-text-primary placeholder-text-tertiary focus:outline-none focus:ring-2 focus:ring-purple/50 focus:border-purple resize-none transition-colors disabled:opacity-50"
              />
            </div>
            <button
              onClick={handleSend}
        ...
        {showSaveDialog && (
          ...
          >
            ...
            <motion.div
              ...
              className="relative w-full max-w-md bg-[#FFFFFF] border border-[#DCE4E7] rounded-card shadow-2xl p-6"
            >
