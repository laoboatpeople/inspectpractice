            ...
            <div className="space-y-3">
              <div className="relative">
                ...
                <input
                  ...
                  minLength={8}
                  autoComplete="new-password"
                  className="w-full px-3 py-2 border border-border rounded-md text-sm bg-[#071D2B] text-text-primary placeholder-text-tertiary focus:outline-none focus:border-blue/50 pr-10"
                />
                <button type="button" onClick={() => setShowPassword(!showPassword)} className="absolute right-3 top-[30px] text-text-tertiary hover:text-text-secondary">
                  {showPassword ? <EyeOff size={14} /> : <Eye size={14} />}
                </button>
              ...
              <div>
                ...
                <input
                  ...
                  autoComplete="new-password"
                  className="w-full px-3 py-2 border border-border rounded-md text-sm bg-[#071D2B] text-text-primary placeholder-text-tertiary focus:outline-none focus:border-blue/50"
                />
              </div>
