      ...
      <div className="min-h-screen bg-[#0A0E1A] text-[#F8FAFC]">
        <nav className="border-b border-white/5 bg-[#0A0E1A]/80 backdrop-blur-md">
          <div className="max-w-3xl mx-auto px-6 py-4 flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              ...
              <a href="/fr" className="px-3 py-1 rounded-full bg-white/10 border border-white/20 hover:bg-white/20 text-sm font-medium transition-colors">FR</a>
            </div>
          </div>
        </nav>
        ...
        <article className="max-w-3xl mx-auto px-6 pt-16 pb-24">
          ...
          <div className="prose prose-invert max-w-none text-[#CBD5E1] leading-relaxed space-y-6">
            <h2 className="text-xl font-semibold text-[#F8FAFC] mt-10">What Are ICC Certifications?</h2>
            <p>
            ...
            <h2 className="text-xl font-semibold text-[#F8FAFC] mt-10">The Five Core Certifications</h2>
            ...
            <h2 className="text-xl font-semibold text-[#F8FAFC] mt-10">Exam Format: Open Book, Code in Hand</h2>
            <p>
