            ...
            {editing ? (
              <div className="space-y-2">
                <input
                  ...
                  className="w-full bg-white text-text-primary rounded-btn px-3 py-2 text-sm border border-border focus:outline-none focus:border-blue transition-colors"
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-white text-text-primary rounded-btn pl-9 pr-3 py-2 text-sm border border-border focus:outline-none focus:border-blue transition-colors"
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full bg-white text-text-primary rounded-btn px-4 py-2.5 pr-10 text-sm border border-border focus:outline-none focus:border-blue transition-colors"
                  required
                />
                <button
                  type="button"
