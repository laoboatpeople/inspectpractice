                ...
                >
                  ...
                  >
                    ...
                    <textarea
                      ...
                      rows={3}
                      className="w-full px-3 py-2.5 rounded-input bg-white border border-border text-text-primary text-sm placeholder:text-text-tertiary focus:outline-none focus:ring-2 focus:ring-blue focus:ring-offset-2 focus:ring-offset-white transition-colors resize-none"
                    />
